...
| **Quality scoring** | dziewięć trwałych evaluations C3 + wersjonowane progi C4; komplet, binding, wersja i twarde naruszenia są sprawdzane fail-closed | self-report trzech evaluations pozostaje otwartym P2 i gate'em C5 | WORKING OFFLINE — C4 CANDIDATE |
...
| **Approval & autonomy** | C4 egzekwuje macierz LEVEL_0–3 dla ARTICLE/NOTE i zapisuje human-required albo autonomous outcome; panel, decyzja człowieka i publikacyjne limity pozostają późniejsze | autonomia dotyczy WYKONANIA, nie ujawniania natury agenta (ADR-018) | PARTIAL — C4 CANDIDATE |
...
### 3.5. Decyzja o gotowej treści (C4 CANDIDATE; bez publikacji)
