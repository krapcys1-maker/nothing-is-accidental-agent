...
| SQLite + 24 migracje w kodzie (`0001`–`0024`, produkcja: 20) + repozytoria | `app/storage/` | C1–C3 dostarczają `0021`–`0023`; C4 dodaje append-only ledger `0024_autonomous_content_decision`, atomową decyzję pod fence i jawny migrator `0023→0024`. Runtime wymaga dokładnie `0024`; produkcja pozostaje na `0020`, 20 migracjach i nie została zmigrowana. |
