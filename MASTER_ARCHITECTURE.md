...
>
> Każde bieżące twierdzenie o stanie obecnym zostało zweryfikowane w kodzie i testach (**1288 test cases collected and passed offline; exact-once `306+312+328+342`**) albo przez kontrolowany wynik positive-live i niezależny końcowy review 223/223. Pełny 1288 nie był ponownie uruchamiany w samym niezależnym review; reviewer potwierdził bajtową identyczność kodu/testów z wcześniej zaakceptowanym review. Wartości 1235 i starsze są historycznymi baseline'ami. Twierdzenia niezweryfikowane oznaczono `NOT VERIFIED`.
>
