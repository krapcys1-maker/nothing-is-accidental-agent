...
>
> Każde bieżące twierdzenie o kandydacie naprawy zostało zweryfikowane w kodzie i testach (**1331 test cases collected and passed offline; exact-once `320+322+339+350`**) albo przez QA: schema-gate 17/17, settled recovery 4/4 i lineage 10/10. Historyczne 1328/1311/1288/223 nadal dowodzą poprzednich fal; nie są bieżącym baseline'em po RR-01. Twierdzenia niezweryfikowane oznaczono `NOT VERIFIED`.
>
