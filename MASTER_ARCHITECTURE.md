...
>
> Każde bieżące twierdzenie o kandydacie naprawy zostało zweryfikowane w kodzie i testach (**1311 test cases collected and passed offline; exact-once `314+319+333+345`**) albo przez niezależny QA `settled_execution_recovery_disproof.py` 4/4. Historyczne 1288/223 nadal dowodzi accepted positive-live; nie jest bieżącym baseline'em kodu po naprawie. Twierdzenia niezweryfikowane oznaczono `NOT VERIFIED`.
>
