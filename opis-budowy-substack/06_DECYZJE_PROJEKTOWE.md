...
- **Granica:** brak claimu, dispatchu, researchu, resume, API, działań paid/browser/public, nowych migracji, cron/service/autostartu i okien redakcyjnych. Maintenance celowo działa przy worker disabled/safe/kill, bo jest wyłącznie safety cleanup. One-shot i poll są VERIFIED OFFLINE; scheduler systemowy i okna redakcyjne pozostają NOT_STARTED.
