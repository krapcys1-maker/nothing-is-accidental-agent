...
>
> **PR #1 PO PR1-MAJ-005-RR-01 = `CANDIDATE FOR ONE NARROW INDEPENDENT RE-REVIEW` (2026-07-18, ADR-097).** Runtime wymaga dokładnie `0015`, nie migruje i nie tworzy DB. Po immutable preflight otwiera tylko istniejący plik przez URI `mode=rw`, ponawia gate na uzyskanym handle i dopiero po sukcesie wykonuje mutujące przygotowanie połączenia. Testy usunięcia i podmiany pliku potwierdzają brak odtworzenia/mutacji, sidecarów, runtime, providera i kosztu. Dowód: 1331/1331, exact-once `320+322+339+350`, QA schema-gate `17/17`, recovery `4/4`, lineage `10/10`. Produkcja nadal schema `0014`; `0015` nie została zastosowana. Etap 2 pozostaje `NOT STARTED`, kolejny live `NOT AUTHORIZED`, bez merge.
>
