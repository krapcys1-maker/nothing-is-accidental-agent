    ...
    def discover(self, request: SourceDiscoveryRequest) -> SourceDiscoveryResponse:
        ...
        response = client.messages.create(
            ...
            messages=[{"role": "user", "content": (
                ...
                "it. So at least two sources must speak to the WHY: an impact "
                "assessment, consultation or its response, a regulator's decision or "
                "review, a post-implementation evaluation, an official inquiry, or an "
                "industry economics analysis that states the incentive in its own "
                "words. At least one source must carry quantified data - figures, "
                "rates, volumes or shares - not only description.\n"
