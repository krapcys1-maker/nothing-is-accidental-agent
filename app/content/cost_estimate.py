...
ARTICLE_RESEARCH_MAX_OUTPUT_TOKENS = 8_192
...
ROLE_ENVELOPES: dict[LogicalModelRole, RoleEnvelope] = {
    LogicalModelRole.TOPIC_GENERATION: RoleEnvelope(
        TOPIC_GENERATION_MAX_INPUT_TOKENS,
        TOPIC_GENERATION_MAX_CONTEXT_TOKENS,
        TOPIC_GENERATION_MAX_OUTPUT_TOKENS,
    ),
    LogicalModelRole.ARTICLE_RESEARCH: RoleEnvelope(
