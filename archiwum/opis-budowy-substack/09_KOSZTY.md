...
> **2026-08-14 — pierwsze realne przebiegi live Etapu 3:** koszt sesji `1.849415 USD`, dzień łącznie `10.167678 USD`. Rozbicie: TOPIC_GENERATION `0.064260` (zmarnowane, urwany JSON) + `0.077960` (zmarnowane, urwany JSON) + `0.069410` (OK) + `0.091310` (OK); research temat 92 `0.763560` (karta REJECT); discovery temat 96 `0.782915` (korpus zablokowany). **Zmarnowane bezpowrotnie: `0.1423` na zgadywanie `max_tokens` mimo jedenastu udanych przebiegów w bazie oraz `~0.78` na korpus tematu 96.** Zawieszona ekspozycja `0.485760` o nieustalonym obciążeniu. Żaden artykuł nie powstał.
