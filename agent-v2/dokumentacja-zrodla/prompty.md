...
#### `ciekawostki.md` (119 wierszy)

**Pola wejściowe:** `dziedziny`, `generatory`, `ile`, `miesiac`, `uzyte`, `w_reku`
...
#### `weryfikacja.md` (62 wierszy)

**Pola wejściowe:** `context`, `text`
