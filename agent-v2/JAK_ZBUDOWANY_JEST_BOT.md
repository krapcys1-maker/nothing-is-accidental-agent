...
|---|---|---|
| maksimum 10 plików `.py` | **23 plików**, 29 161 wierszy | **PRZEKROCZONE** |
...
testów, 3530 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
7526 wierszy, 136 funkcji na poziomie modułu, 0 klas
