...
|---|---|---|
| maksimum 10 plików `.py` | **18 plików**, 15 573 wierszy | **PRZEKROCZONE** |
...
testów, 1467 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
590 wierszy, 6 funkcji na poziomie modułu, 0 klas
