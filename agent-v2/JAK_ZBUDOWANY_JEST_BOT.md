...
|---|---|---|
| maksimum 10 plików `.py` | **25 plików**, 32 960 wierszy | **PRZEKROCZONE** |
...
testów, 4151 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
9532 wierszy, 155 funkcji na poziomie modułu, 0 klas
