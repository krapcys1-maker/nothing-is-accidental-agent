...
|---|---|---|
| maksimum 10 plików `.py` | **26 plików**, 34 177 wierszy | **PRZEKROCZONE** |
...
testów, 4342 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
9779 wierszy, 155 funkcji na poziomie modułu, 0 klas
