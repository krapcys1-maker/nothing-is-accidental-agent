...
|---|---|---|
| maksimum 10 plików `.py` | **19 plików**, 16 962 wierszy | **PRZEKROCZONE** |
...
się testować bez przeglądarki i bez pieniędzy**. 61 zestawów
testów, 1645 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
5325 wierszy, 103 funkcji na poziomie modułu, 0 klas
