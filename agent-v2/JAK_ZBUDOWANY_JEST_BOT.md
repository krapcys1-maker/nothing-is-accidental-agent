...
|---|---|---|
| maksimum 10 plików `.py` | **19 plików**, 17 070 wierszy | **PRZEKROCZONE** |
...
testów, 1649 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
5382 wierszy, 103 funkcji na poziomie modułu, 0 klas
