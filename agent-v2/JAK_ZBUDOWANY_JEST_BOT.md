...
|---|---|---|
| maksimum 10 plików `.py` | **25 plików**, 32 116 wierszy | **PRZEKROCZONE** |
...
testów, 3867 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
8938 wierszy, 151 funkcji na poziomie modułu, 0 klas
