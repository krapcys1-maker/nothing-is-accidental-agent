...
|---|---|---|
| maksimum 10 plików `.py` | **18 plików**, 15 483 wierszy | **PRZEKROCZONE** |
...
testów, 1460 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
543 wierszy, 6 funkcji na poziomie modułu, 0 klas
