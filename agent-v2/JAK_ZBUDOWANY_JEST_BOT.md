...
|---|---|---|
| maksimum 10 plików `.py` | **18 plików**, 15 466 wierszy | **PRZEKROCZONE** |
...
testów, 1457 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
4558 wierszy, 95 funkcji na poziomie modułu, 0 klas
...
526 wierszy, 6 funkcji na poziomie modułu, 0 klas
