...
|---|---|---|
| maksimum 10 plików `.py` | **24 plików**, 30 153 wierszy | **PRZEKROCZONE** |
...
testów, 3597 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
8060 wierszy, 141 funkcji na poziomie modułu, 0 klas
