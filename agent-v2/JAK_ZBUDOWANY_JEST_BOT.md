...
|---|---|---|
| maksimum 10 plików `.py` | **24 plików**, 30 706 wierszy | **PRZEKROCZONE** |
...
testów, 3669 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
2966 wierszy, 27 funkcji na poziomie modułu, 1 klas
