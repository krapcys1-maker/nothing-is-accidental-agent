...
- **Statusy:** one-shot maintenance = VERIFIED OFFLINE; poll maintenance = VERIFIED OFFLINE; usługa schedulera systemowego i okna redakcyjne = NOT_STARTED; realne resume = NOT IMPLEMENTED; live API = NOT VERIFIED; paid/browser/public = BLOCKED.
