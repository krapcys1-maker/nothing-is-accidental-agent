...
> Historyczny import instrukcji projektu Claude Cowork (zarchiwizowany 2026-07-12, ADR-023). Zawiera zalozenia uchylone przez ADR-017 (autonomia) i ADR-018 (jawnosc AI) oraz nieaktualna nadrzednosc GROWTH_MASTER. Obowiazuje: AGENTS.md (nowa wersja), MASTER_ARCHITECTURE.md, IMPLEMENTATION_ROADMAP.md, CURRENT_PROJECT_STATE.md, docs/DECISIONS.md.
