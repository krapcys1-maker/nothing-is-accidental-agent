...
TRYB_SERWERA = _env("AGENT_V3_SERVER", "0").lower() in {"1", "true", "yes"}
...
MODEL_FOR = {
    ...
    # $2,12 zamiast $0,61.
    "write": FABLE,
    # Redaktor poprawia istniejący tekst minimalnie. Ten sam model co pisarz,
    # bo zmiana głosu podczas naprawy byłaby nową wadą.
    "revise": FABLE,
    "review": DEEPSEEK_PRO,
...
CHEAP_MODE = _env("AGENT_V3_CHEAP", "0").lower() in {"1", "true", "yes"}
...
#   AGENT_V3_WRITER=claude-fable-5 python agent-v3/run.py --use-cache
_writer = _env("AGENT_V3_WRITER")
if _writer:
...
MAX_TOKENS = {
    ...
    "revise": _tokens_for(MAX_WORDS * 7) + 6000,
