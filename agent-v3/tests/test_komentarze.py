...
zrodlo_run = pathlib.Path("agent-v3/run.py").read_text(encoding="utf-8")
...
szablon = pathlib.Path("agent-v3/prompts/komentarz.md").read_text(encoding="utf-8")
...
sprawdz("run.py zapisuje postawe do dziennika",
        'out.get("postawa")' in pathlib.Path("agent-v3/run.py").read_text(encoding="utf-8"))
