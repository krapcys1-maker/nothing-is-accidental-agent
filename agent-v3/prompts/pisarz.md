...
## Editorial memory — constraints, not evidence

This is the publication's memory of previous work and reader reactions. Use it
to avoid repeated arguments, continue unresolved questions and vary the move.
It is **not evidence**. Never take a fact or number from this block into the
article unless the evidence card below independently contains it.
